...
import org.springframework.web.bind.annotation.CrossOrigin; // 記得要 import
...
public class MenuController {
    ...
    public Map<String, Object> getFullData() {
        ...
        menu.add(createCategory("雞蛋燒", Arrays.asList(
            createItem("肉鬆起司蛋", 45, "人氣推薦 / 全熟蛋"),
            createItem("只有肉鬆蛋", 40, "全熟蛋"),
            createItem("起司蛋燒", 40, "全熟蛋")
        )));

        menu.add(createCategory("雞蛋糕", Arrays.asList(
        ...
        menu.add(createCategory("呷涼的", Arrays.asList(
            createItem("甘甜冷泡茶", 25, ""),
            createItem("蜜香紅茶", 25, "")
        )));
